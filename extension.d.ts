interface EventTarget {
    ...
    ["#fireEvent"]<K extends keyof HTMLElementEventMap>(
        eventType: K,
        eventInit?: Partial<HTMLElementEventMap[K]>): void,
    ["#delete"](): void,
    ["#data"](): any;
    ["#data"](key: string): any;
    ...
    ["#$"](): HTMLElement,
    ["#on"]<K extends keyof HTMLElementEventMap>(eventList: K, handlerCallback: (this: HTMLElement, ev: HTMLElementEventMap[K]) => any): void,
    ["#off"]<K extends keyof HTMLElementEventMap>(eventList: K, handlerCallback: (this: HTMLElement, ev: HTMLElementEventMap[K]) => any): void,
}
interface Window {
    env: {
        NODE_ENV: string
...
interface String {
    ...
    ["#parseUc"]<T = import("./src/Usercontrol.js").Usercontrol>(uc: T): string,
    /**
    ...
    ["#devEsc"](): string,
   // ["#convertToFullPath"](importUrl?:string): import("./src/ipc/ProjectManage.ts").IResolvePathResult,
    ["#PHP_REMOVE"](): string,
    ["#PHP_ADD"](): string,
}
