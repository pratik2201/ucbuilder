...
export class footerMenu$Designer extends Usercontrol {    
    private static _FILE_PATH = '../../../../src/MainDashboard/footerMenu.uc.html'; 
    ...
    static Create(pera: IUcOptions, ...args: any[]): footerMenu { 
        /**  */
        return intenseGenerator.generateUC(this.FILE_PATH,footerMenu,import.meta.url,pera,...args) as footerMenu;
    }
    static async CreateAsync(pera: IUcOptions, ...args: any[]): Promise<footerMenu> {
        return (await intenseGenerator.generateUCAsync( this.FILE_PATH, footerMenu, import.meta.url, pera, ...args)) as footerMenu;
    }
    get(id:"") {
    ...
    async initializecomponentAsync(args: IUcOptions, form: footerMenu) {
        ...
        await Usercontrol.GenerateControls(this,args,args.cfInfo.pathOf[".js"]/*Usercontrol.Resolver(args.source.htmlImportMetaUrl ?? import.meta.url,footerMenu$Designer.FILE_PATH)*/);
        /*
    ...
    initializecomponent(argsLst: IArguments, form: footerMenu) {
        //return;
        let fargs = Usercontrol.extractArgs(arguments);
        let args = fargs[fargs.length-1] as IUcOptions;
        let ucExt = this.ucExtends;
