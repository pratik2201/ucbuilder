...
class regsManage {
    ...
    tText = undefined;
    static onDotPropCall = (node: object, cellname: string) => {
        return ''
    }
    onDotPropCall = (node: object, cellname: string) => {
        return ''
    }
    /**
     * 
